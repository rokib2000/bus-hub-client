    ...
    <div>
      <div className="">
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="bg-cover bg-center h-56 p-4" style={{ backgroundImage: `url(${banner1})` }}></div>

          <div className="p-4">
            <p className="uppercase tracking-wide  text-lg font-bold text-gray-700 mb-2">Detached house</p>
            <p className=" text-gray-900 mb-2">
              <strong>Original Price:</strong> $750,000
            </p>
            <p className="text-lg font-semibold text-gray-900">Resell Price: $750,000</p>
